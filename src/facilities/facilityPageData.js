...
import roomImage from "../assets/bannerimage/roomsbanner.png";
import equipment11Image from "../assets/bannerimage/Equipments-11.jpg";
import canteenImage from "../assets/hospital/canteen.jpg";
import pharmacyImage from "../assets/bannerimage/pharmacybanner.png";
import hospitalImage from "../assets/bannerimage/insurancebanner.png";

const standardSafety = "We follow robust safety, hygiene and quality-control practices so every patient and family receives dependable care.";
const standardHighlights = [
  { icon: "clock", title: "24×7 Availability", text: "Round-the-clock support whenever care is needed." },
  { icon: "heart", title: "Patient First", text: "Comfort, dignity and clear guidance at every step." },
  { icon: "shield", title: "Safe Care", text: "Well-defined safety and hygiene practices." },
  { icon: "nurse", title: "Expert Team", text: "Trained staff focused on responsive support." },
];
...
const facilityPageData = {
  ...
  lab: { title: "Laboratory Services", eyebrow: "Precision diagnostics", tagline: "Answers You Can Trust", description: "Reliable laboratory testing with careful sample handling, automated systems and timely reporting to support clinical decisions.", heroImage: laboratoryImage, highlights: standardHighlights, services: ["Haematology testing", "Clinical biochemistry", "Microbiology services", "Pathology support", "Automated analysers", "Timely diagnostic reporting"], safetyNote: "Quality checks and safe sample processes help support accurate, dependable reports." },
  radiology: { title: "Radiology & Imaging", eyebrow: "Advanced diagnostics", tagline: "Clarity for Better Care", description: "Comprehensive imaging services that support accurate diagnosis and clinical decision-making with patient safety at the centre.", heroImage: radiologyImage, highlights: standardHighlights, services: ["Digital X-ray", "Ultrasound imaging", "CT & MRI coordination", "Specialised investigations", "Safe imaging protocols", "Timely reporting"], safetyNote: "Every examination is performed with careful attention to image quality, comfort and radiation safety." },
  rooms: { title: "Patient Rooms", eyebrow: "Comfort in recovery", tagline: "Rest. Heal. Recover.", description: "Comfortable accommodation options designed around clinical needs, privacy and a supportive environment for patients and families.", heroImage: roomImage, featureImage: equipment11Image, highlights: standardHighlights, services: ["Suite rooms", "Deluxe rooms", "Private rooms", "General wards", "24×7 nursing support", "Attendant facilities"], safetyNote: "Clean, well-maintained rooms and attentive support help create a comfortable recovery experience." },
...
export default facilityPageData;
