...
className="bg-gradient-to-r from-rose-600 to-orange-500 hover:opacity-90 text-white py-2 rounded-lg font-semibold"
...
className="border border-rose-600 text-rose-600 py-2 rounded-lg text-center font-semibold hover:bg-rose-50"
...
className="w-full bg-gradient-to-r from-rose-600 to-orange-500 text-white py-3 rounded-lg font-semibold"
