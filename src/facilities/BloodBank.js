...
export default function BloodBank() {
  ...
  const images = [
    "https://via.placeholder.com/400x300?text=Blood+Bank+1",
    "https://via.placeholder.com/400x300?text=Blood+Bank+2",
    "https://via.placeholder.com/400x300?text=Blood+Bank+3",
  ];
    ...
    <div className="pt-[9rem] pb-20 bg-gradient-to-b from-red-50 to-white font-[Poppins]">
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="relative rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-red-900/80 to-transparent flex items-center">
            <motion.h1
              initial="hidden"
              animate="visible"
              variants={fadeUp}
      ...
      <section className="max-w-7xl mx-auto px-6 mt-16">
        ...
        >
          <h2 className="text-3xl font-bold text-red-700">Safe Blood Storage</h2>
          <p className="text-gray-700 mt-4 leading-7 text-lg">
            Our Blood Bank follows strict guidelines for collection, screening,
            processing, and storage. We ensure safe blood components for all
      ...
      <section className="max-w-7xl mx-auto px-6 mt-12 grid md:grid-cols-3 gap-8">
        {[
          ...
          >
            <h3 className="text-xl font-semibold text-red-700">{item}</h3>
          </motion.div>
        ))}
      </section>
    </div>
