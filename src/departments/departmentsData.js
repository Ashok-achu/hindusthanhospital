...
The department offers General Anaesthesia, Regional Anaesthesia including spinal, epidural and nerve blocks, and Monitored Anaesthesia Care (MAC). Specialized services include Obstetric Anaesthesia, Paediatric Anaesthesia, Cardiovascular Anaesthesia, Neuro-Anaesthesia, and Onco-Anaesthesia. Day-care procedures such as bronchoscopy, thoracoscopy, endoscopy, and colonoscopy are well supported. Continuous education and research help maintain high standards of care.
`,
  services: [
    "General Anaesthesia",
...
======================= */
{
  ...
  description: `
The Department of ENT and Head & Neck Surgery provides comprehensive diagnosis and treatment for disorders of the ear, nose, throat, and head & neck region.

Advanced endoscopic and microscopic techniques are used for both medical and surgical management. The department also specializes in the treatment of head and neck cancers, voice disorders, and sleep-related breathing problems.
`,
  services: [
    "ENT OPD & Endoscopy",
    "Sinus Surgery",
...
======================= */
{
  ...
  description: `
The Department of General Medicine provides comprehensive care for acute and chronic medical conditions. Special focus is given to preventive healthcare, diabetes management, and geriatric medicine.

The department emphasizes early diagnosis, lifestyle modification, and long-term disease management to improve overall patient health and well-being.
`,
  services: [
...
======================= */
{
  ...
  description: `
The Department of General & Laparoscopic Surgery offers a wide range of surgical procedures using both open and minimally invasive techniques.

Modern operation theatres, advanced instruments, and skilled surgeons ensure reduced pain, faster recovery, and better surgical outcomes for patients.
`,
  services: [
...
======================= */
{
  ...
  description: `
The Department of Neonatology provides advanced intensive care for premature and critically ill newborns.

State-of-the-art NICU facilities and experienced neonatologists ensure high-quality neonatal outcomes.
`,
  services: [
    "NICU Level III Care",
...
======================= */
{
  ...
  description: `
The Department of Orthopaedics provides advanced care for bone, joint, and spine disorders.

Comprehensive services include joint replacement surgery, trauma care, fracture management, and sports injury treatment.
`,
  services: [
...
======================= */
{
  ...
  description: `
The Department of Paediatrics offers comprehensive healthcare for infants, children, and adolescents.

Preventive care, emergency services, and long-term management of childhood illnesses are provided in a child-friendly environment.
`,
  services: [
    "Immunization",
    "Pediatric Emergency",
...
======================= */
{
  ...
  description: `
The Department of Paediatric Surgery provides specialized surgical care for congenital and acquired conditions in infants and children.

Minimally invasive techniques and advanced neonatal support ensure safe surgical outcomes.
`,
  services: [
    "Newborn Surgery",
...
======================= */
{
  ...
  description: `
The Institute of Lung Care and Research (ILCR) provides advanced respiratory care using modern diagnostic and therapeutic techniques.

Specialized clinics address asthma, COPD, sleep disorders, and chronic lung diseases.
`,
  services: [
    "Asthma & COPD Clinics",
...
======================= */
{
  ...
  description: `
The Department of Physical Medicine & Rehabilitation focuses on restoring mobility and function following injury, illness, or surgery.

Personalized rehabilitation programs improve recovery and enhance quality of life.
`,
  services: [
    "Physiotherapy",
...
======================= */
{
  ...
  description: `
Established in 1992, the Department of Urology provides comprehensive diagnosis and treatment for urological disorders.

Advanced day-care surgical facilities and modern diagnostic equipment support effective management of urinary and reproductive conditions.
`,
  services: [
    "Kidney Stones",
    "Prostate Disorders",
